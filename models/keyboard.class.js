class Keyboard {
  ...
  initEventListeners() {
    this.addButtonEventListeners(
      "btnLeft",
      "mobileGameButtonImageLeft",
      "img/buttons/LeftArrow (1).png",
      "img/buttons/LeftArrow (2).png",
      "LEFT"
    );
    this.addButtonEventListeners(
      "btnRight",
      "mobileGameButtonImageRight",
    ...
    this.addButtonEventListeners(
      "btnJump",
      "mobileGameButtonImageJump",
      "img/buttons/Up (1).png",
      "img/buttons/Up (2).png",
      "UP"
    );
    this.addButtonEventListeners(
      "btnThrow",
